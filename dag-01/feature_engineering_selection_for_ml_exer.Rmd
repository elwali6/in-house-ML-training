...
We use three months exchange rate dats between between the EUR and American USD. From the time series we create 11 indicators (features) We are going to take several variables from some indicators. Then we will write a function that forms the final input set of 17 variables, that wil be used to predict if the exchange rate will go up or down. see hereunder.
