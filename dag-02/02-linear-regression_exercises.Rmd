---
title: "Solutions Q8, Q9 and Q10 from Chapter 3 ISLR"
...
Textbook: Introduction to statistical learning, Chapter 3, p. 121
...
* We can answer this question by again testing the hypothesis $H_0 : \beta_i = 0\ \forall i$. The p-value corresponding to the F-statistic is `r round(as.numeric(pf(summary(fit2)$fstatistic[1], summary(fit2)$fstatistic[2], summary(fit2)$fstatistic[3], lower.tail = F)),2)`, this indicates a clear evidence of a relationship between "mpg" and the other predictors.*
